...
describe('FSK SFD (Start Frame Delimiter) Tests', () => {
  ...
  describe('SFD Configuration', () => {
    test('default SFD pattern is included in configuration', () => {
    ...
    test('custom SFD pattern can be configured', () => {
  ...
  describe('0x55 User Data Transmission', () => {
    test('can transmit single 0x55 byte as user data', () => {
      const userData = new Uint8Array([0x55]); // Same as preamble pattern
      
      const modulatedSignal = fskCore.modulateData(userData);
    ...
    test('can transmit multiple 0x55 bytes as user data', () => {
    ...
    test('mixed data including 0x55 is transmitted correctly', () => {
  ...
  describe('SFD Pattern Transmission', () => {
    test('can transmit SFD pattern (0x7E) as user data', () => {
    ...
    test('mixed data including both 0x55 and 0x7E', () => {
  ...
  describe('Frame Structure Verification', () => {
    test('signal structure includes preamble + SFD + data', () => {
    ...
    test('longer data transmission with SFD', () => {
  ...
  describe('SFD vs Preamble Distinction', () => {
    test('preamble pattern in data does not cause false sync', () => {
    ...
    test('multiple transmissions are distinguished correctly', () => {
      ...
      const result2 = fskCore.demodulateData(signal2);
  ...
  describe('Error Cases', () => {
    test('empty data with SFD structure', () => {
      const emptyData = new Uint8Array([]);
      
      const modulatedSignal = fskCore.modulateData(emptyData);
